...
const DATA = {
  ...
  digitalProjects: [
    {
      title: "Heritage Park Taguig — Promo Video",
      period: "2026",
      org: "Video Editing · CapCut / Adobe Premiere",
      desc: "Edited a promotional video showcasing Heritage Park's facilities and services, combining motion graphics with cinematic footage for social media campaigns.",
      img: "image/heritage.png",
    },
    {
      title: "Bimbo's Coffee — Brand Visual Identity",
      period: "2026",
      org: "Graphic Design · Photoshop / Canva",
      desc: "Designed product posters, menu layouts, and social media content that elevated the coffee shop's brand presence and customer engagement.",
      img: "",
    },
    {
      title: "ROMA Tours — Marketing Materials",
      period: "2025",
      org: "Digital Design · Photoshop / Illustrator",
      desc: "Created digital marketing assets including social media banners, booking confirmation graphics, and promotional flyers for the bus booking platform.",
      img: "",
    },
    {
      title: "PSITE Event — Motion Graphics",
      period: "2024",
      org: "Motion Design · After Effects",
      desc: "Produced animated intro sequences and lower thirds for PSITE college events and tech seminars.",
      img: "",
    },
    {
      title: "Personal Brand — Social Media Content",
      period: "2023 — Present",
      org: "Content Creation · Canva / CapCut",
      desc: "Managed and designed content for personal branding across Facebook and Instagram, including reels, carousels, and story templates.",
      img: "",
    },
  ],
  education: [
